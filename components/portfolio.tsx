...
const projects: Project[] = [
  ...
  },
  {
    ...
    github: 'https://github.com',
    tags: ['Vite', 'TypeScript', 'Node,js', 'Java Script'],
  },
  {
    id: 5,
    title: 'Smart Home IoT',
    description: {
      es: 'Sistema de automatización del hogar con IoT y control por voz',
      en: 'Home automation system with IoT and voice control',
      pt: 'Sistema de automação residencial com IoT e controle por voz',
    },
    image: '/projects/project-5.jpg',
    url: 'https://example.com/project5',
    tags: ['IoT', 'Arduino', 'Node.js', 'MQTT'],
  },
  {
    id: 6,
